...
import 'package:pixel_mercenary/game/level_design_config.dart';
import 'package:pixel_mercenary/game/wave_spawn_table.dart';
...
class MyApp extends StatelessWidget {
  ...
  static const gameId = 'MG-0003';
  static const gameTitle = 'Pixel Mercenary Guild';
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            MGAdaptiveText('MG-0003 STABILIZED', style: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
